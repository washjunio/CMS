...
export interface ApiKw16Kw16 extends Schema.CollectionType {
  collectionName: 'kw_16s';
  info: {
    singularName: 'kw-16';
    pluralName: 'kw-16s';
    displayName: 'KW-16';
  ...
  attributes: {
    ...
    versao: Attribute.Integer;
    production: Attribute.Boolean;
    enviroment: Attribute.Enumeration<['Prod', 'Stg']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRl90Rl90 extends Schema.CollectionType {
  collectionName: 'rl_90s';
  info: {
    singularName: 'rl-90';
    pluralName: 'rl-90s';
    displayName: 'RL90';
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    features: Attribute.Component<'features.blocks', true> & Attribute.Required;
    highlight: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
...
export interface ApiSt12St12 extends Schema.CollectionType {
  collectionName: 'st_12s';
  info: {
    singularName: 'st-12';
    pluralName: 'st-12s';
    displayName: 'ST12';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::kw-16.kw-16': ApiKw16Kw16;
      'api::post.post': ApiPostPost;
      'api::rl-90.rl-90': ApiRl90Rl90;
      'api::service.service': ApiServiceService;
      'api::st-12.st-12': ApiSt12St12;
    }
  }
}
